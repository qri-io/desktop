...
import { BACKEND_PORT, DISCORD_URL } from '../constants'

const PortOccupied: React.FC<{}> = () => (
  <WelcomeTemplate title='Cannot Load App'>
    <div className='port-occupied'>
      <div>Qri Desktop cannot start because another process is occupying port <strong>{BACKEND_PORT}</strong>, which the app relies on in order to function properly.</div>
